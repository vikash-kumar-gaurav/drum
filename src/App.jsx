  ...
  return (
    <>
      <div className='background w-full h-screen flex items-center justify-center md:gap-5 gap-9'>
        ...
        <div className={`text-white   sm:h-[60px] sm:w-[55px] md:h-[75px] md:w-[75px] w-[90px] h-[90px] box flex flex-col items-center pt-3 border-2 border-white ${activeKey === "S" ?'scale-125 duration-300 border-yellow-600 shadow-xl shadow-blue-600':''}`}><h1 className='font-extrabold '>B</h1><span className=''>clap</span></div>
